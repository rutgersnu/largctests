...
#tag = "_data_bnb_rolling_unblind_mcc9_pre_oct_reco_1d"
#tag = "_data_bnb_rolling_unblind_mcc9_beta1_oct_reco_2d"
#tag = "_prodgenie_bnb_nu_cosmic_uboone_mcc9.0_beta1_oct_reco_2d_dic"
#tag = "_prodgenie_bnb_nu_cosmic_uboone_mcc9.0_pre_oct_reco_1d"
#tag = "_prodgenie_bnb_nu_cosmic_uboone_mcc9.0_beta2_oct_reco_2d_wc"
#tag = "_data_bnb_run1_unblind_mcc9_beta1_oct_reco_2d"
tag = "_data_bnb_run1_unblind_mcc9_pre_oct_reco_1d"
...
#file = ROOT.TFile.Open("/uboone/data/users/cerati/ddstudies"+tag+".root")
#file = ROOT.TFile.Open("/uboone/data/users/cerati/skim_splittrackntuple"+fnme+tag+".root")
file = ROOT.TFile.Open("tkres"+tag+"_reco2.root")
...
for tc in testcase:
    ...
    dr_vs_coszx = ROOT.TH2F("h"+tc+"dr_vs_coszx","h"+tc+"dr_vs_coszx",5,-1,1,100,-0.5,0.5)
    dur_vs_coszx = ROOT.TH2F("h"+tc+"dur_vs_coszx","h"+tc+"dur_vs_coszx",5,-1,1,100,-0.1,0.1)
    dphi_vs_coszx = ROOT.TH2F("h"+tc+"dphi_vs_coszx","h"+tc+"dphi_vs_coszx",10,-1,1,100,-0.3,0.3)
    dtheta_vs_coszx = ROOT.TH2F("h"+tc+"dtheta_vs_coszx","h"+tc+"dtheta_vs_coszx",10,-1,1,100,-0.2,0.2)
    ...
    dr_vs_coszy = ROOT.TH2F("h"+tc+"dr_vs_coszy","h"+tc+"dr_vs_coszy",5,-1,1,100,-0.5,0.5)
    dur_vs_coszy = ROOT.TH2F("h"+tc+"dur_vs_coszy","h"+tc+"dur_vs_coszy",5,-1,1,100,-0.1,0.1)
    dphi_vs_coszy = ROOT.TH2F("h"+tc+"dphi_vs_coszy","h"+tc+"dphi_vs_coszy",10,-1,1,100,-0.3,0.3)
    dtheta_vs_coszy = ROOT.TH2F("h"+tc+"dtheta_vs_coszy","h"+tc+"dtheta_vs_coszy",10,-1,1,100,-0.2,0.2)
