...
#alg = "PMA"
alg = "KalmanTrack"
#alg = "KalmanTrack_scale001"

algnoscale = alg.replace("_scale001","")

#tag = "_data_mcc8.4_pandoraNu"+alg
tag = "_bnb_cosmics_mcc8.4_pandoraNu"+alg
#tag = "_bnb_mcc8.4_pandoraNu"+alg
...
file = ROOT.TFile.Open("/uboone/data/users/cerati/splittrackntuple"+tag+".root")
#file = ROOT.TFile.Open("/uboone/data/users/cerati/skim_splittrackntuple"+fnme+tag+".root")
...
for tc in testcase:
    ...
    dp_vs_len = [dx_vs_len, dy_vs_len, dz_vs_len, dux_vs_len, duy_vs_len, duz_vs_len]
    ...
    dp_vs_nh = [dx_vs_nh, dy_vs_nh, dz_vs_nh, dux_vs_nh, duy_vs_nh, duz_vs_nh]
    ...
    dp_vs_x = [dx_vs_x, dy_vs_x, dz_vs_x, dux_vs_x, duy_vs_x, duz_vs_x]
    ...
    dp_vs_y = [dx_vs_y, dy_vs_y, dz_vs_y, dux_vs_y, duy_vs_y, duz_vs_y]
    ...
    dp_vs_z = [dx_vs_z, dy_vs_z, dz_vs_z, dux_vs_z, duy_vs_z, duz_vs_z]
    ...
    dp_vs_ux = [dx_vs_ux, dy_vs_ux, dz_vs_ux, dux_vs_ux, duy_vs_ux, duz_vs_ux]
    ...
    dp_vs_uy = [dx_vs_uy, dy_vs_uy, dz_vs_uy, dux_vs_uy, duy_vs_uy, duz_vs_uy]
    ...
    dp_vs_uz = [dx_vs_uz, dy_vs_uz, dz_vs_uz, dux_vs_uz, duy_vs_uz, duz_vs_uz]
    ...
    dp_vs_mcmom = [dx_vs_mcmom, dy_vs_mcmom, dz_vs_mcmom, dux_vs_mcmom, duy_vs_mcmom, duz_vs_mcmom]
    h_dp_vs_mcmom.append(dp_vs_mcmom)
    # track resolution vs track angle in zx plane
    dx_vs_coszx = ROOT.TH2F("h"+tc+"dx_vs_coszx","h"+tc+"dx_vs_coszx",5,-1,1,100,-0.5,0.5)
    dy_vs_coszx = ROOT.TH2F("h"+tc+"dy_vs_coszx","h"+tc+"dy_vs_coszx",5,-1,1,100,-0.5,0.5)
    dz_vs_coszx = ROOT.TH2F("h"+tc+"dz_vs_coszx","h"+tc+"dz_vs_coszx",5,-1,1,100,-0.5,0.5)
    dux_vs_coszx = ROOT.TH2F("h"+tc+"dux_vs_coszx","h"+tc+"dux_vs_coszx",5,-1,1,100,-0.1,0.1)
    duy_vs_coszx = ROOT.TH2F("h"+tc+"duy_vs_coszx","h"+tc+"duy_vs_coszx",5,-1,1,100,-0.1,0.1)
    duz_vs_coszx = ROOT.TH2F("h"+tc+"duz_vs_coszx","h"+tc+"duz_vs_coszx",5,-1,1,100,-0.1,0.1)
    dp_vs_coszx = [dx_vs_coszx, dy_vs_coszx, dz_vs_coszx, dux_vs_coszx, duy_vs_coszx, duz_vs_coszx]
    h_dp_vs_coszx.append(dp_vs_coszx)
    # track resolution vs track angle in zy plane
    dx_vs_coszy = ROOT.TH2F("h"+tc+"dx_vs_coszy","h"+tc+"dx_vs_coszy",5,-1,1,100,-0.5,0.5)
    dy_vs_coszy = ROOT.TH2F("h"+tc+"dy_vs_coszy","h"+tc+"dy_vs_coszy",5,-1,1,100,-0.5,0.5)
    dz_vs_coszy = ROOT.TH2F("h"+tc+"dz_vs_coszy","h"+tc+"dz_vs_coszy",5,-1,1,100,-0.5,0.5)
    dux_vs_coszy = ROOT.TH2F("h"+tc+"dux_vs_coszy","h"+tc+"dux_vs_coszy",5,-1,1,100,-0.1,0.1)
    duy_vs_coszy = ROOT.TH2F("h"+tc+"duy_vs_coszy","h"+tc+"duy_vs_coszy",5,-1,1,100,-0.1,0.1)
    duz_vs_coszy = ROOT.TH2F("h"+tc+"duz_vs_coszy","h"+tc+"duz_vs_coszy",5,-1,1,100,-0.1,0.1)
    dp_vs_coszy = [dx_vs_coszy, dy_vs_coszy, dz_vs_coszy, dux_vs_coszy, duy_vs_coszy, duz_vs_coszy]
    ...
    dp_vs_ismu = [dx_vs_ismu, dy_vs_ismu, dz_vs_ismu, dux_vs_ismu, duy_vs_ismu, duz_vs_ismu]
    ...
    dp_vs_ntkvtx = [dx_vs_ntkvtx, dy_vs_ntkvtx, dz_vs_ntkvtx, dux_vs_ntkvtx, duy_vs_ntkvtx, duz_vs_ntkvtx]
    ...
    dp_vs_contain = [dx_vs_contain, dy_vs_contain, dz_vs_contain, dux_vs_contain, duy_vs_contain, duz_vs_contain]
    ...
    dp_vs_mommumcs = [dx_vs_mommumcs, dy_vs_mommumcs, dz_vs_mommumcs, dux_vs_mommumcs, duy_vs_mommumcs, duz_vs_mommumcs]
    ...
    dp_vs_mommurng = [dx_vs_mommurng, dy_vs_mommurng, dz_vs_mommurng, dux_vs_mommurng, duy_vs_mommurng, duz_vs_mommurng]
    ...
    dp_vs_mompmcs = [dx_vs_mompmcs, dy_vs_mompmcs, dz_vs_mompmcs, dux_vs_mompmcs, duy_vs_mompmcs, duz_vs_mompmcs]
    ...
    dp_vs_momprng = [dx_vs_momprng, dy_vs_momprng, dz_vs_momprng, dux_vs_momprng, duy_vs_momprng, duz_vs_momprng]
...
for t in tree: 
    ...
    #if vx_ntks<2 or vx_ntks>3: continue
    #if tk_gpar[4]<-0.6 or tk_gpar[4]>0.6: continue
    #
    if tk_contain == 1: continue
    if not passSelII: continue
    if vx_ntks<1: continue
    if tk_drvtx>3.: continue
    #
