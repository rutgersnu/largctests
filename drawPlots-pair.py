...
#samples.append("data_bnb_optfilter_C1_5e19_goodruns_v08_00_00_12_reco2")
#methods.append("12")
#labels.append("BNB Run1 data")
#colors.append(ROOT.kBlack)

samples.append("prodgenie_bnb_nu_uboone_overlay_mcc9_v12")
methods.append("12")
labels.append("BNB Run1 Overlay")
colors.append(ROOT.kRed)

samples.append("prodgenie_bnb_nu_only_mcc9_v12_reco2")
methods.append("12")
labels.append("BNB Only MC")
...
for i in range (0,h1.GetNbinsX()):
    ...
    h1pi.Draw()
    h1pi.Fit("gaus","MLEQ","",h1pi.GetMean()-h1pi.GetRMS()*1.5,h1pi.GetMean()+h1pi.GetRMS()*1.5)
    #h1pi.Fit("gaus","MLEQ","",h1pi.GetMean()-h1pi.GetRMS()*2,h1pi.GetMean()+h1pi.GetRMS()*2)
    if savefits:
...
for i in range (0,h2.GetNbinsX()):
    ...
    h2pi.Draw()
    h2pi.Fit("gaus","MLEQ","",h2pi.GetMean()-h2pi.GetRMS()*1.5,h2pi.GetMean()+h2pi.GetRMS()*1.5)
    #h2pi.Fit("gaus","MLEQ","",h2pi.GetMean()-h2pi.GetRMS()*2,h2pi.GetMean()+h2pi.GetRMS()*2)
...
pad1.BuildLegend(0.451,0.552,0.895,0.892,"Exiting Tracks","")
